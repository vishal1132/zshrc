...
alias pip='pip3'
alias activate='source /Users/vishal/Downloads/tools/virtualenvironment/bin/activate'
alias jmeter='sh /Users/vishal/Downloads/tools/jmeter/apache-jmeter-5.3/bin/jmeter'
alias lf='ls -Fals'
alias lfl='ls -Fals | less'
alias lfc='ls -FalsC'
alias lfcl='ls -FalsC | less'
alias swagger='swagger-codegen'
alias please='sudo'
alias nocod='cd /Users/vishal/work/src/github.com/vishal1132'
